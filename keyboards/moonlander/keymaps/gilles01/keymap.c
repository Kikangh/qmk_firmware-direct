...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, LCTL(BP_DQOT),  LCTL(BP_LGIL),  LGUI(LSFT(BP_M)),KC_BSPACE,      KC_DELETE,                                      KC_TRANSPARENT, BP_AT,          LCTL(LGUI(LSFT(BP_DOT))),LCTL(LSFT(KC_TAB)),LCTL(KC_TAB),   KC_TRANSPARENT, BP_W,           
